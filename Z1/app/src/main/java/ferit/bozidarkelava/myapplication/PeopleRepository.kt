...
import ferit.bozidarkelava.myapplication.R.array.DennisRitchie
...
object PeopleRepository {
    ...
    fun getPerson(index: Int): InspiringPerson? = famousPersons.find { famousPersons ->
        famousPersons.index == index
    }
